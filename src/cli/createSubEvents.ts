...
async function main() {
  ...
  const outSubs: { type: string; id: string; parentEventId: string | null; parentTitle: string; title: string; about: string; aboutCopy?: string; aboutHeader?: string; aboutSlim?: string; aboutSlimNoExtraInfo?: string; aboutSlimMyExtraInfo?: string; aboutCalculated?: string; aboutCalculated2?: string; aboutSubEvent?: string; extraInfo?: string; extraInfo2?: string; startTimeText: string; endTimeText?: string | null; startTime?: string; endTime?: string | null }[] = [];
  const nonSubs: any[] = [];
  let totalFound = 0;
